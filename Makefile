...
# OLIMEX_ARM_STM32_H405=1							# Olimex ARM STM35-H405
# OLIMEX_ARM_STM32_H405_BOOTLOADER=1	# Olimex ARM STM35-H405 with bootloader
...
else ifdef OLIMEX_ARM_STM32_H405
EMBEDDED=1
USE_NET=1
USE_GRAPHICS=1
DEFINES += -DUSE_USB_OTG_FS=1
BOARD=OLIMEX_ARM_STM32_H405
STLIB=STM32F40_41xxx
PRECOMPILED_OBJS+=$(ROOT)/targetlibs/stm32f4/lib/startup_stm32f40_41xxx.o
OPTIMIZEFLAGS+=-O3

else ifdef OLIMEX_ARM_STM32_H405_BOOTLOADER
EMBEDDED=1
USE_NET=1
USE_GRAPHICS=1
DEFINES += -DUSE_USB_OTG_FS=1
